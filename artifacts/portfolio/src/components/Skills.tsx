...
import {
  ...
  SiDotnet, SiGit, SiMysql, SiCplusplus, SiPhp, SiOpenai,
} from "react-icons/si";
import { Database, Code, Server, Cpu, GitBranch, Layers } from "lucide-react";
...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Full-Stack", icon: Layers, color: "#64b5f6" },
    ],
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        >
          {proficiencies.map((item, i) => (
            <div key={item.name} data-testid={`proficiency-${i}`}>
